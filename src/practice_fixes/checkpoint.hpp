...
struct SupplementalPlayerState {
    ...
    float m_streakStrokeWidth = 0.0f;
    bool m_disableStreakTint = false;
    bool m_alwaysShowStreak = false;
    ShipStreak m_shipStreakType = ShipStreak::None;
    ...
    SupplementalPlayerState(PlayerObject* p) {
        ...
        m_shipStreakType                = p->m_shipStreakType;
        ...
        m_jumpRelatedAC2                = p->m_jumpRelatedAC2;
