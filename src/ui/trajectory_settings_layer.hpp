...
class TrajectorySettingsLayer : public geode::Popup, public TextInputDelegate {
  ...
  private:
    ...
    bool init() override {
        if (!Popup::init(250, 180, Utils::getTexture().c_str()))
            return false;
        ...
        input->setString(Mod::get()
                             ->getSavedValue<std::string>("trajectory_length")
                             .c_str());
    ...
    cocos2d::ccColor4F ccColor4FFromccColor4B(const cocos2d::ccColor4B &color) {
        return cocos2d::ccColor4F(color.r / 255.0f, color.g / 255.0f,
    ...
    void openColorPicker(CCObject *obj) {
        ...
        popup->setCallback([this, color](const cocos2d::ccColor4B &newColor) {
            ...
            Mod::get()->setSavedValue("trajectory_color1",
                                      ShowTrajectory::ccc3BFromccc4F(
                                          ccColor4FFromccColor4B(newColor)));
        });
